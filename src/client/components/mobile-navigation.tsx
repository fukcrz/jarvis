...
export function MobileSessionSwitcher(props: MobileSessionSwitcherProps) {
  ...
  return <section className="mobile-page mobile-all-sessions-page" aria-label="全部会话">
    <header className="mobile-switcher-header"><Button variant="ghost" size="icon" aria-label="返回聊天" onClick={props.onClose}><ArrowLeft size={19} /></Button><strong>全部会话</strong><Button variant="ghost" size="icon" aria-label="新建会话" onClick={requestCreateSession} disabled={props.workspaces.length === 0}><Plus size={20} /></Button></header>
