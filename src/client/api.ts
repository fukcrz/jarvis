...
export const api = {
  ...
  updateSettings: async (patch: Partial<Pick<AppSettings, "assistantName" | "uiMode">>): Promise<AppSettings> => (await request<{ settings: AppSettings }>("/api/settings", { method: "PATCH", body: JSON.stringify(patch) })).settings,
