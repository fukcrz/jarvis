...
- Production-build browser startup and hydration on desktop and mobile, session switching, history loading, streaming delta coalescing, rich Markdown/tool-heavy DOM work, composer interaction, Chromium runtime metrics, Long Tasks, layout shifts, resource bytes, and heap/DOM indicators.
